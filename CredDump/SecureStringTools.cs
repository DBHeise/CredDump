///https://raw.githubusercontent.com/LiquidHg/kraken/3bff29619c63af073d05f7bbd616c1cddc2d74ff/packages/Kraken.DotNet.Core.0.2.6-alpha02/src/Kraken.Core.Security/Unsafe/SecureStringTools.cs
...
namespace Kraken.Core.Security.Unsafe
{
    ...
    public class SecureStringTools
    {
        ...
        {
            fixed (char* strFixed = text)
            { // don't have a really great reason for fixed, but what the hey, right!
