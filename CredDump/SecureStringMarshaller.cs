///https://raw.githubusercontent.com/LiquidHg/kraken/3bff29619c63af073d05f7bbd616c1cddc2d74ff/packages/Kraken.DotNet.Core.0.2.6-alpha02/src/Kraken.Core.Security/SecureStringMarshaller.cs
using System;
using System.IO;
...
namespace Kraken.Core.Security
{
    ...
    public class SecureStringMarshaller : IDisposable
    {
        ...
        public unsafe byte[] EncodeToByteArray(Encoding encoding, DataProtectionScope protectionScope, byte[] optionalEntropy)
        {
            ...
            { // plaintext is readable, fix it so it can't be moved by GC
